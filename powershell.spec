...
Emulator Terminala dla systemu X11 Window. Możliwości:
- Pełne wsparcie dla GNOME
- Wsparcie dla wielu okien terminali w jednym oknie XWindow
- Opcje menu by otworzyć programy typu bash, tcsh, pine, emacs.
- Możliwość zmiany opcji menu poprzez plik konfiguracyjny jak i
  Ustawienia
- Możliwość przełączania się pomiędzy terminalami z klawiatury z
  Ctrl-1, Ctrl-2
- Wsparcie dla przezroczystości, obrazków tła itp
